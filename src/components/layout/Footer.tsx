      ...
      <div className="container-px grid gap-10 py-14 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-[var(--tw-text-muted)]">
            ...
            <li className="flex items-center gap-2.5">
              <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4 shrink-0 text-fresh-500" aria-hidden="true">
                <path d={WHATSAPP_PATH} />
              </svg>
              <a href={`https://wa.me/${WHATSAPP_NUMBER}`} target="_blank" rel="noopener noreferrer" className="transition-colors hover:text-brand-500">WhatsApp</a>
            </li>
          </ul>
        </div>
